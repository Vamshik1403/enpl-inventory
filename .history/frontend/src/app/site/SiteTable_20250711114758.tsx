...
const SiteTable: React.FC = () => {
  ...
  const handleCreate = async () => {
    try {
      ...
      await axios.post("http://http://192.168.29.167:8000/sites", payload);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(`http://http://192.168.29.167:8000/sites/${currentSite.id}`, payload);
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await axios.delete(`http://http://192.168.29.167:8000/sites/${id}`);
                  ...
                  {currentSites.map((site) => (
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4 text-gray-700">
                        {site.gstpdf ? (
                          <a
                            href={`http://http://192.168.29.167:8000/gst/${site.gstpdf}`}
                            target="_blank"
