...
const TaskTable: React.FC = () => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      if (userType === "SUPERADMIN") {
        response = await axios.get("http://http://192.168.29.167:8000/tasks");
      } else {
        response = await axios.get(
          `http://http://192.168.29.167:8000/tasks/user/${userId}`
        );
      }
  ...
  const fetchDepartments = async () => {
    try {
      const response = await axios.get(
        "http://http://192.168.29.167:8000/departments"
      );
  ...
  const fetchExecutives = async () => {
    try {
      const response = await axios.get(
        "http://http://192.168.29.167:8000/users/executives"
      );
  ...
  const fetchManagers = async () => {
    try {
      const response = await axios.get(
        "http://http://192.168.29.167:8000/users/managers"
      );
  ...
  const fetchHodsByDepartment = async (departmentName: string) => {
    try {
      const response = await axios.get(
        `http://http://192.168.29.167:8000/users/hods/${departmentName}`
      );
  ...
  const fetchManagersByDepartment = async (departmentName: string) => {
    try {
      const response = await axios.get(
        `http://http://192.168.29.167:8000/users/manager/${departmentName}`
      );
  ...
  const fetchExecutivesByDepartment = async (departmentName: string) => {
    try {
      const response = await axios.get(
        `http://http://192.168.29.167:8000/users/executive/${departmentName}`
      );
  ...
  const fetchServicesByDepartment = async (departmentId: number) => {
    try {
      const response = await axios.get(
        `http://http://192.168.29.167:8000/tasks/services/${departmentId}`
      );
  ...
  const fetchCustomers = async () => {
    try {
      const response = await axios.get("http://http://192.168.29.167:8000/customers");
  ...
  const fetchSitesByCustomer = async (customerId: number) => {
    try {
      const response = await axios.get(
        `http://http://192.168.29.167:8000/sites/customer/${customerId}`
      );
  ...
  const handleDelete = async (id: number) => {
    try {
      await axios.delete(`http://http://192.168.29.167:8000/tasks/${id}`);
  ...
  const fetchAllHods = async () => {
    try {
      const response = await axios.get("http://http://192.168.29.167:8000/users/hods");
  ...
  const handleSave = async () => {
    try {
      ...
      if (isEditing) {
        await axios.put(
          `http://http://192.168.29.167:8000/tasks/${formData.id}`,
          sanitizedData
        );
        setAlert({ type: 'success', message: 'Task updated successfully!' });
      } else {
        await axios.post("http://http://192.168.29.167:8000/tasks", sanitizedData);
