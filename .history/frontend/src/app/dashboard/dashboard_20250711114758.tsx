    ...
    const fetchCounts = async () => {
      try {
        const responses = await Promise.all([
          fetch('http://http://192.168.29.167:8000/vendors/count'),
          fetch('http://http://192.168.29.167:8000/customers/count'),
          fetch('http://http://192.168.29.167:8000/sites/count'),
          fetch('http://http://192.168.29.167:8000/products/count'),
          fetch('http://http://192.168.29.167:8000/inventory/purchaseRate/count'),
          fetch('http://http://192.168.29.167:8000/inventory/sold/purchaseRate'),
          fetch('http://http://192.168.29.167:8000/inventory/rest/sold'),
          fetch('http://http://192.168.29.167:8000/inventory/count/purchaseInvoice'),
          fetch('http://http://192.168.29.167:8000/inventory/count/dueAmount'),
          fetch('http://http://192.168.29.167:8000/inventory/count/demo'),
          fetch('http://http://192.168.29.167:8000/tickets/count/open'),
          fetch('http://http://192.168.29.167:8000/tickets/count/closed'),
          fetch('http://http://192.168.29.167:8000/tickets/count/inprogress'),
          fetch('http://http://192.168.29.167:8000/tickets/count/resolved'),
          fetch('http://http://192.168.29.167:8000/tickets/count/reopened'),
          fetch('http://http://192.168.29.167:8000/tickets/count/all'),
        ]);
