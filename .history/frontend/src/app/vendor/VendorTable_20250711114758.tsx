...
const VendorTable: React.FC = () => {
  ...
  const fetchVendors = async () => {
    const response = await axios.get("http://http://192.168.29.167:8000/vendors");
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get("http://http://192.168.29.167:8000/category");
  ...
  const handleDelete = async (id?: number) => {
    ...
    try {
      await axios.delete(`http://http://192.168.29.167:8000/vendors/${id}`);
 ...
 const handleCreate = async () => {
  ...
  try {
    ...
    if (formData.id) {
      await axios.put(`http://http://192.168.29.167:8000/vendors/${formData.id}`, payload);
      setAlert({ type: 'success', message: 'Vendor updated successfully!' });
    } else {
      await axios.post("http://http://192.168.29.167:8000/vendors", payload);
                    ...
                    <div className="space-y-4 mt-6">
                      ...
                      <div className="space-y-2">
                        ...
                        {!gstPdfFile && formData.gstpdf && (
                          <a
                            href={`http://http://192.168.29.167:8000/gst/${formData.gstpdf}`}
                            target="_blank"
                  ...
                  {currentVendors.map((vendor) => (
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4">
                        {vendor.gstpdf ? (
                          <a
                            href={`http://http://192.168.29.167:8000/gst/${vendor.gstpdf}`}
                            target="_blank"
                            rel="noopener noreferrer"
